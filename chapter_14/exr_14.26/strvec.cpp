...
string &StrVec::operator[](size_t num){
    return elements[num];
}

const string &StrVec::operator[](size_t num) const{
    return elements[num];
}
...
void StrVec::push_back(const string &str){
    ...
    cout << "Was push_back with l-value!\n";
}

void StrVec::push_back(string &&str){
    check_n_alloc();
    alloc.construct(firstFree++, move(str));
    cout << "Was push_back with r-value!\n";
}
